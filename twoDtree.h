...
public:
   ...
   * splitting lines. It will also call helper function buildTree.
   ...
   void renderHelper(Node* root, PNG & photo);
   ...
   * You may want a recursive helper function for this one.
   ...
   void pruneHelper(double pct, int tol, Node* root);

   int getTotalLeaves(Node* root);

   int getTotalLeavesWithin(Node* root, int tol, Node* thisNode);
