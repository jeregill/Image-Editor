...
int main()
{
	...
	twoDtree t1(origIm1);
	PNG testIm = t1.render();
	testIm.writeToFile("images/testIm.png");
	twoDtree testCopy(t1);
	PNG test_Copy = testCopy.render();
	test_Copy.writeToFile("images/testCopy.png");

	testCopy.prune(0.95, 10000);
	PNG ppic1 = testCopy.render();
